...
export default function GoogleSignInButton({
  ...
  /** Where to land after the round-trip; the browse wall sends /browse. */
  next?: string;
}) {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {/* Directly under the button, because the question it answers —
          what does Google hand over — is asked at the moment of
          pressing it, not on a policy page. */}
      <p className="text-xs text-muted">{t("googleDataNote")}</p>
    </div>
  );
}
